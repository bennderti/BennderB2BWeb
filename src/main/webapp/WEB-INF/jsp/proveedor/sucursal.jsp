...
<head>
    ...
    <link href="<c:url value="/resources/beneficio/css/bootstrap.min.css"/>?v=<%=Calendar.getInstance().getTimeInMillis()%>"
          rel="stylesheet">
    <link href="<c:url value="/resources/beneficio/css/style.css"/>?v=<%=Calendar.getInstance().getTimeInMillis()%>"
          rel="stylesheet">

    <title>Bennder App - Mantenedor</title>

    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
    <link href="<c:url value="/resources/beneficio/css/ie10-viewport-bug-workaround.css"/>?v=<%=Calendar.getInstance().getTimeInMillis()%>"
          rel="stylesheet">
    <!-- Custom styles for this template -->
    <link href="<c:url value="/resources/beneficio/css/sticky-footer.css"/>?v=<%=Calendar.getInstance().getTimeInMillis()%>"
          rel="stylesheet">
    <script type="text/javascript"
            src="<c:url value="/resources/beneficio/js/ie10-viewport-bug-workaround.js"/>?v=<%=Calendar.getInstance().getTimeInMillis()%>"></script>
</head>
...
<div class="container formulario_mantenedor">
    <form:form method="POST"
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <form:input path="nombre" id="ipt-nombre" cssClass="form-control"
                            placeholder="Ingrese nombre de sucursal" maxlength="50"/>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-sm-2" for="ipt-hora-atencion">Horario Atención:</label>
            <div class="col-md-4">
                <form:input path="horarioAtencion" id="ipt-hora-atencion" cssClass="form-control"
                            placeholder="Ingrese horario de atención" maxlength="100"/>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <form:input path="oficina" id="ipt-oficina" cssClass="form-control" placeholder="Ingrese oficina"
                            maxlength="100"/>
            </div>
        </div>
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <button type="submit" class="btn btn-primary btn-guardar-beneficio"
                    onclick="Sucursal.onValidaGuardaSucursal();">Guardar Sucursal
            </button>
...
<footer class="footer">
    <div class="container">
        <p class="text-muted">Copyright ©2017 Bennder. Todos los derechos reservados. | ¿Tienes alguna duda? <a
                href="mailto:soporte@bennder.club?subject=Contacto por soporte proveedor">soporte@bennder.club</a></p>
    </div>
</footer>
<!-- FOOTER MANTENEDOR -->
...
<!-- AGREGA ELIMINA -->
<script type="text/javascript"
        src="<c:url value="/resources/beneficio/js/sucursal/sucursal.js"/>?v=<%=Calendar.getInstance().getTimeInMillis()%>"></script>
<script type="text/javascript">
    function onCancelar() {
        ModalBennder.mostrar({
            titulo: "Sucursal", mensaje: "¿Está seguro que desea salir?", eventoAceptar: function () {
